...
class WarningEntry(Model):
    ...
    user_id = fields.ForeignKeyField(model_name="models.Users", to_field="user_id")
    reason = fields.TextField()
    issued_by = fields.ForeignKeyField(model_name="models.Admins", to_field="admin_user_id")
